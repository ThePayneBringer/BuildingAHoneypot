...
funnel_handler = RotatingFileHandler('http.audits.log', maxBytes = 2000, backupCount = 5)
...
def web_honeypot(input_username="admin", input_password="password"):
    ...
    def login():
        ...
        funnel_logger.info('Client with IP Address: {ip_address} entered\n Username: {username}')

        if username == input_username and passsword == input_password:
